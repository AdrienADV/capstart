...
<Cards>
  ...
  <Card
    ...
    description="Start from the Capstart boilerplate or follow an opinionated Vite React + Capacitor setup."
  />
  <Card
    title="Deployment"
...
Start with **Installation** if you are creating a new app from scratch. Use the boilerplate for Supabase auth and mobile UI already wired, then run the CLI to generate native projects with your app id; use the manual path when you want to configure every layer yourself.
