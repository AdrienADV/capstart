...
<Cards>
  <Card
    title="CLI"
    href="/docs/cli"
    description="Create a Capstart boilerplate app, or add Capacitor to an existing Next.js, Nuxt, React + Vite, Svelte + Vite, SvelteKit, TanStack Start, or Vue app."
  />
  <Card
    title="Installation"
...
Start with the **CLI** if you want to create a new app from the Capstart boilerplate or if you already have a Next.js, Nuxt, React + Vite, Svelte + Vite, SvelteKit, TanStack Start, or Vue application. `capstart create` scaffolds the boilerplate; `capstart init` configures an existing app for Capacitor.
